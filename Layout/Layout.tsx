...
const Layout = ({navbarSx, title ,children ,desc } : ILayout) => {
  ...
  return (
    ...
    <>
    <Head >
        <title>{title || "Phan Văn Đức Portfolio - Kỹ Sư Điện Tử Viễn Thông"}</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <link rel="shortcut icon" href="https://phanduc.eu.org/avatar.png" />
  
   
    
<meta name="description" content={`${desc || 'Phan Văn Đức - Thiết kế website và ứng dụng'}`} />


<meta property="og:title" content="Phan Văn Đức Portfolio | Kỹ Sư Điện Tử Viễn Thông" />


<meta property="og:url" content="https://phanduc.eu.org" />


<meta property="og:description" content="Phan Văn Đức | Kỹ Sư Điện Tử Viễn Thông. Và đây là Portfolio của tôi"/>


<meta property="og:image" content="https://phanduc.eu.org/avatar.png"/>
...
<meta property="og:type" content="article" /> */}
   ...
   <meta httpEquiv="content-language" content="en"/>
    ...
    <meta name="author" content="Phan Văn Đức" />
