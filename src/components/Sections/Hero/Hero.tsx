                ...
                <Grid item xs={12} sm={10} md={8} lg={7}>
                    <Box ref={ref}>
                        ...
                        <Typography
                           ...
                           Tôi là sinh viên chuyên ngành Điện tử Viễn thông tại Đại học Mở Hà Nội. Tôi có niềm đam mê mãnh liệt với điện tử và phát triển phần mềm. Tôi luôn thích thú với việc tạo ra những sản phẩm kết hợp giữa phần cứng vi mạch và giao diện web hiện đại.
                        </Typography>
                        ...
                        <a href={`https://drive.google.com/drive/folders/1hXrsWs6UghZl9KgGeRy7BNWd_RMmR1zL?usp=sharing`} rel="noreferrer" target='_blank' >
