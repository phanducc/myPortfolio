...
const Contact = () => {
    ...
    return (
        <Layout
            title='Cách liên hệ với tôi | Phan Đức'
            desc='Nếu bạn cần, hãy liên hệ với tôi tại phanduc.2915@gmail.com hoặc qua số điện thoại 0966469425. Tôi sẽ trả lời bạn sớm nhất có thể.'>
                ...
                <Container
                    ...
                    <Box
                        ...
                        <Box sx={{
                            ...
                            <ContactBox 
                            href='mailto:phanduc.2915@gmail.com'
                            target='_blank'
                            t1='Liên lạc' t2='Địa chỉ Email' t3='phanduc.2915@gmail.com'/>
                            <ContactBox 
                            href={`https://maps.app.goo.gl/fgANza8aXxUyWfyS9`}
                            target='_blank'
                            t1='Địa chỉ'
                             t2='Tôi sống ở' t3='Hà Nội, Việt Nam'/>
                            <ContactBox 
                            target='_blank'
                            href={'https://zaloapp.com/qr/p/ozlbozewqjin?src=qr'}
                            t1='Liên lạc' t2='Số điện thoại' t3='+84/966469425'/>
                        </Box>
                    </Box>
                    <SocialMedia/>
